...
console.log(`Full URL: https://www.etsy.com/oauth/connect?response_type=code&redirect_uri=http://localhost:8000/oauth/redirect&scope=listings_r&client_id=170d5qb8vihfduhni6kw0fry&state=${state}&code_challenge=${codeChallenge}&code_challenge_method=S256`)